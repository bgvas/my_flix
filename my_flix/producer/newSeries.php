...
if(isset($_POST['title']) && isset($_POST['description']) && isset($_POST['createdAt'])  && isset($_POST['category']) && isset($_POST['participant']) && isset($_POST['participantRole'])){
    AddNewSeries($user, $_POST['title'], $_POST['description'], $_POST['createdAt'],  $_POST['category'], $_POST['participant'], $_POST['participantRole']);
            ...
            <div class="row">
                <div class="col-12">
                    <div class="bg-dark text-white h3 p-2 border">
                        <p class="text-center">Add new Series</p>
                        <form action = "../producer/newSeries.php" method = "post">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary w-50">Save New Series</button>
                            </div>
                        </form>
                    </div>
                </div>  
